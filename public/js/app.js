...
/* harmony import */ var _fileShare__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./fileShare */ "./resources/js/fileShare.js");
/* harmony import */ var _themeSwitcher__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./themeSwitcher */ "./resources/js/themeSwitcher.js");
...
for (var i = 0; i < categoryTitle.length; i++) {
  categoryTitle[i].addEventListener('click', filterPosts.bind(undefined, categoryTitle[i]));
}
...
function updateCart(drug) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/update_cart', drug).then(function (res) {
    console.log(res);
...
addToCart.forEach(function (btn) {
  ...
  btn.addEventListener('click', function (e) {
    var drug = JSON.parse(btn.dataset.drug);
    updateCart(drug); //console.log(drug)
  });
}); //-------------Toast JS File-------------

(0,_toast__WEBPACK_IMPORTED_MODULE_2__.initToast)(); //-------------Email File Share-------------

(0,_fileShare__WEBPACK_IMPORTED_MODULE_3__.initFilesShare)(); //-------------Theme Switcher------------

(0,_themeSwitcher__WEBPACK_IMPORTED_MODULE_4__.initTheme)();
(0,_sunSwitecher__WEBPACK_IMPORTED_MODULE_5__.initSun)(); //--------------SideBar Manufacturer Panel---------

(0,_new__WEBPACK_IMPORTED_MODULE_6__.initNew)();
...
/* harmony export */   "initFilesShare": () => (/* binding */ initFilesShare)
/* harmony export */ });
...
var status = document.querySelector('.status'); // const { response } = require('express');
...
function initFilesShare() {
  ...
  if (dropZone) {
    ...
    dropZone.addEventListener("dragleave", function (e) {
      dropZone.classList.remove("dragged"); //    console.log("drag ended");
    });
  ...
  var upload = function upload() {
    ...
    formData.append("myfiles", files[0]); //show the uploader
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "initNew": () => (/* binding */ initNew)
/* harmony export */ });
var options = {
  series: [{
    name: "Net Profit",
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "initSun": () => (/* binding */ initSun)
/* harmony export */ });
function initSun() {
  ...
  Date.DEGREES_PER_HOUR = 360 / 24; // Utility functions
...
/* harmony export */ });
var themSwitcher = document.querySelector('#themeSwitcher');
...
function initTheme() {
  ...
  themSwitcher.addEventListener('change', function (e) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "initToast": () => (/* binding */ initToast)
/* harmony export */ });
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var noty__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! noty */ "./node_modules/noty/lib/noty.js");
...
function initToast() {
  ...
  window.onload = function () {
    function ajax() {
      var xhr = new XMLHttpRequest(); //creating new XML object
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkDrugChain"] = self["webpackChunkDrugChain"] || [];
